    ...
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">
                DevWebCamp es una conferencia para todos los desarrolladores de todos los niveles, se lleva a cabo de forma presencial y en línea.
            </p>
        </div>
        ...
        <nav class="menu-redes"> 
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://x.com/?lang=es">
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://www.tiktok.com/?lang=es">
