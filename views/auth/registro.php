<main class="auth">
    ...
    <form action="/registro" method="post" class="formulario">
        ...
        <div class="formulario__campo">
            ...
            <input type="text" class="formulario__input" id="nombre" name="nombre" placeholder="Ej: Nombre...">
        </div>

        <div class="formulario__campo">
            <label for="apellido" class="formulario__label">Apellido</label>
            <input type="text" class="formulario__input" id="apellido" name="apellido" placeholder="Ej: Apellido...">
        </div>
